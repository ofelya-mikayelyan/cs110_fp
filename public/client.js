...
const getIndex = function(){
    ...
    info.append('<div id = "bmicalc"><p>Weight in kilograms: <input type="text" placeholder="Enter weight in kilograms..." id="weight"></p>');
    info.append('<p>Height in meters: <input type="text" placeholder="Enter height in meters..." id="height"></p>');
    info.append('<p><button id ="bmi">Compute BMI</button></p></div>');
    info.append('<div id = "indexresult"></div>');
